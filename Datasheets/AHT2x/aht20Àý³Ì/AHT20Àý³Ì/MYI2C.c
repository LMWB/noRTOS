...
* Return         : None
*******************************************************************************/
void MYI2C_GPIO_MODE(unsigned char TYP) //����MCU�޸���Ӧ��IO��ʼ��
{
#ifdef  ARM32   	
...
* Return         : None
*******************************************************************************/
unsigned char MYI2C_GPIO_DATA(unsigned char TYP)//����MCU�޸���Ӧ��IO����
{
unsigned int dat=0;	
...
{	
	  RCC_APB2PeriphClockCmd(RCC_APB2Periph_GPIOB, ENABLE);  //ʹ��SDA��SCL�˿�ʱ�ӣ�����51��Ƭ������Ҫ��ע�͵����С�
