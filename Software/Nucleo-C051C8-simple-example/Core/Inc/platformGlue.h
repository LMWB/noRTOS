...
#define NUCLEO_BUTTON_READ()		HAL_GPIO_ReadPin(GPIOC, GPIO_PIN_13)

#define NUCLEO_LED_turn_on()		HAL_GPIO_WritePin(GPIOA, GPIO_PIN_5, 1)
#define NUCLEO_LED_turn_off()		HAL_GPIO_WritePin(GPIOA, GPIO_PIN_5, 0)
#define NUCLEO_LED_toggle()			HAL_GPIO_TogglePin(GPIOA, GPIO_PIN_5)
